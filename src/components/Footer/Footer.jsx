...
const Footer = () => {
    return (
        <div>
            <footer className="footer items-center p-4 bg-gray-200 text-neutral-content justify-center dark:bg-gray-900">
                <aside className="items-center justify-center grid-flow-col text-black font-bold dark:text-white">
                    ...
                    <nav className='px-10'>
                        <div className="grid grid-flow-col gap-4">
                            <Link to='https://www.facebook.com/'><CiFacebook /></Link>
                            <Link to='https://github.com/Sudiptacoding'><FaGithub /></Link>
                            <Link to='https://www.linkedin.com/in/sudipta-biswas123/'><CiLinkedin /></Link>
                        </div>
                    </nav>
                </aside>
            </footer>
